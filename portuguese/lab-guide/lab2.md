...
10. A caixa de diálogo Atualizado com êxito para uma avaliação gratuita
    do Microsoft Fabric é aberta. Selecione **Fabric Home Page**.
...
Clique em **Retornar às cargas de trabalho** no canto superior esquerdo
da tela. Essa ação levará você para a página principal de cargas de
trabalho, na qual você poderá explorar outras ferramentas ou seções.
...
Ajuda (?) tem links para ótimos
recursos.   ![](images2/media/image32.png)
...
demonstração/neste laboratório, você aprenderá sobre alguns dos snovos

...
16. 选择**应用**以保存此设置。
   ...
   如前所述，我们需要生成自定义逻辑来处理 SharePoint 中的员工文件未按时送达的应用场景。我们使用数据管道来解决此问题。
...
23. 您的表达式应该是: `@or(equals(variables('varCounter'),3),equals(variables('varIsSuccess'),variables('varSuccess')))`
